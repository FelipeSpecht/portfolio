					...
					<div className="mt-8 sm:mt-12">
						<dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
							<div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center bg-gray-800 dark:border-gray-700">
								...
								<dd className="text-4xl font-extrabold text-cyan-400 md:text-5xl">5 Years</dd>
							</div>
							...
							<div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center bg-gray-800 dark:border-gray-700">
								...
								<dd className="text-4xl font-extrabold text-cyan-400 md:text-5xl">3 Years</dd>
							</div>
							...
							<div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center bg-gray-800 dark:border-gray-700">
								<dt className="order-last text-lg font-medium text-gray-500 dark:text-gray-400">Javascript Frameworks:<br />Node.js; React.js; Next.js</dt>
								<dd className="text-4xl font-extrabold text-cyan-400 md:text-5xl">proficiency</dd>
							</div>

							<div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center bg-gray-800 dark:border-gray-700">
								<dt className="order-last text-lg font-medium text-gray-500 dark:text-gray-400">My coffee taste</dt>
								<dd className="text-4xl font-extrabold text-cyan-400 md:text-5xl">Very Good</dd>
							</div>
						</dl>
					</div>
				</div>
