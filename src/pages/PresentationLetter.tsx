...
export default function PresentationLetter(){
    return (
        <div id="aboutSection" className="block rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-xl sm:mt-4 md:mt-4 sm:mx-auto md:m-auto sm:p-6 lg:p-8 lg:pb-[2.4rem] w-11/12 m-auto lg:w-5/12 lg:inline-block lg:mr-8 lg:align-top lg:mt-10">
            <img alt="" src="telescope.svg" className=" w-20"></img>
            ...
            <Link href="https://www.linkedin.com/in/felipe-specht/" target="_blank"><img alt="" src="linkedin-white.png" className="w-6 inline-block mt-4 cursor-pointer"></img></Link>
            <Link href="https://github.com/FelipeSpecht/" target="_blank"><img alt="" src="github-white.png" className="w-6 ml-3 inline-block mt-5 cursor-pointer"></img></Link>
        </div>
    )
}